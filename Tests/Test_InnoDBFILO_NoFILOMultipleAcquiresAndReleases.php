...
if(count($argv) <= 1)
{
	echo 
		"Usage:".PHP_EOL.
		"  Test_InnoDBFILO_NoFILOMultipleAcquiresAndReleases --databaseName='test' --port=3306 --host='localhost' --username='root' -password='root' --minInnoDBBufferPoolSize=124".PHP_EOL.PHP_EOL.
